...
module Yast
  module SctcrowbarWizardsInclude
    def initialize_sctcrowbar_wizards(include_target)
      Yast.import "UI"
      ...
      Yast.include include_target, "sctcrowbar/complex.rb"
    end

    # Main workflow of the crowbar configuration
    # @return sequence result
    def MainCrowbarSequence
    ...
    def CrowbarSequence
      _aliases = {
        ...
        "main"  => lambda { MainCrowbarSequence() },
